...
public class EnterExtRoom extends AbstractAction {
  ...
  public EnterExtRoom(FDOItemID id, int seat, String room) {
    ...
    if (_sRoom == null) throw new NullPointerException("Null room name");
    if (_sRoom.length() > 20) throw new IllegalArgumentException("QRoom name length > 20");
  }
