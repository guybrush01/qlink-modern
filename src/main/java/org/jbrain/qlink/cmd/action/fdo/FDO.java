...
public class FDO extends AbstractAction {
  ...
  //	0x15 0x0e 0x01 0x11 0x00 Menu item text 0x00 0x05 0x01 0x96 0xc6 serial number packed 0x11 0x00
  // Menu item text 0x00 0x05 0x01 0x96 0xc6 serial number packed 0x09
  ...
  public byte[] getBytes() {
    ...
    if (_bContinue) data[i] = (byte) FDOCommand.CMD_PAUSE_PARSING;
    else data[i] = (byte) FDOCommand.CMD_SHOW;
    finalizeCmd(data);
    return data;
  }
}
