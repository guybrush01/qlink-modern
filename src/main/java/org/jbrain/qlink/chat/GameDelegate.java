...
public class GameDelegate {
   ...
   */
  public GameDelegate(
      RoomDelegate room, int id, String name, String type, boolean systemPickOrder) {
    _iID = id;
    _sName = name;
    _sType = type;
  ...
  public void acceptInvite(QHandle handle) {
    ...
    if (seat != null) {
      ...
      processEvent(
          new GameEvent(
              this, GameEvent.ACCEPT_INVITE, seat.getSeatID(), seat.getHandle().toString()));
    }
  }
  ...
  public void declineInvite(QHandle handle) {
    ...
    if (seat != null) {
      ...
      processEvent(
          new GameEvent(
              this, GameEvent.DECLINE_INVITE, seat.getSeatID(), seat.getHandle().toString()));
    }
  }
  ...
  public void send(QHandle handle, String text) {
    ...
    if (seat != null) {
      GameCommEvent event =
          new GameCommEvent(this, seat.getSeatID(), seat.getHandle().toString(), text);
      record(event);
      processEvent(event);
    }
  }
  ...
  public void requestLoad(QHandle handle) {
    ...
    if (seat != null) {
      ...
      processEvent(
          new GameEvent(
              this, GameEvent.REQUEST_LOAD, seat.getSeatID(), seat.getHandle().toString()));
    }
  }
  ...
  public void readyToStart(QHandle handle) {
    ...
    if (seat != null) {
      ...
      processEvent(
          new GameEvent(
              this, GameEvent.READY_TO_START, seat.getSeatID(), seat.getHandle().toString()));
    }
  }
  ...
  public void requestRestart(QHandle handle) {
    ...
    if (seat != null) {
      ...
      processEvent(
          new GameEvent(
              this, GameEvent.REQUEST_RESTART, seat.getSeatID(), seat.getHandle().toString()));
    }
  }
  ...
  public void acceptRestart(QHandle handle) {
    ...
    if (seat != null) {
      ...
      processEvent(
          new GameEvent(
              this, GameEvent.ACCEPT_RESTART, seat.getSeatID(), seat.getHandle().toString()));
    }
  }
  ...
  public void declineRestart(QHandle handle) {
    ...
    if (seat != null) {
      ...
      processEvent(
          new GameEvent(
              this, GameEvent.DECLINE_RESTART, seat.getSeatID(), seat.getHandle().toString()));
    }
  }
  ...
  private QSeat getGameSeatInfo(QHandle handle) {
    ...
    if (seat != null && _alPlayers.contains(seat)) return seat;
    return null;
  }
