...
import org.jbrain.qlink.cmd.action.AbortDownload;
import org.jbrain.qlink.cmd.action.Action;
import org.jbrain.qlink.cmd.action.AddSubAccount;
import org.jbrain.qlink.cmd.action.DownloadFile;
import org.jbrain.qlink.cmd.action.FileText;
import org.jbrain.qlink.cmd.action.GatewayExit;
import org.jbrain.qlink.cmd.action.GetMenuInfo;
import org.jbrain.qlink.cmd.action.GetSerial;
import org.jbrain.qlink.cmd.action.InitDataSend;
import org.jbrain.qlink.cmd.action.InitDownload;
import org.jbrain.qlink.cmd.action.ListSearch;
import org.jbrain.qlink.cmd.action.MC;
import org.jbrain.qlink.cmd.action.MenuItem;
import org.jbrain.qlink.cmd.action.RequestItemPost;
import org.jbrain.qlink.cmd.action.ResumeService;
import org.jbrain.qlink.cmd.action.SelectDateReply;
import org.jbrain.qlink.cmd.action.SelectFileDocumentation;
import org.jbrain.qlink.cmd.action.SelectList;
import org.jbrain.qlink.cmd.action.SelectMenuItem;
import org.jbrain.qlink.cmd.action.SendSYSOLM;
import org.jbrain.qlink.cmd.action.StartDownload;
import org.jbrain.qlink.cmd.action.TransmitData;
...
public class DepartmentMenu extends AbstractMenuState {
  ...
  protected void connectToGateway(int id) throws IOException {
    try {
      ...
      if (gateway != null) {
        String address = gateway.address();
