...
public class ReadLog {
      ...
      if (line.length() > 19) {
        ...
        if (line.indexOf("RoomDelegate  - Creating") > -1) {
          ...
          bJoining = false;
            ...
            && line.indexOf("Sending packet data: 5A ") > 1
            && line.indexOf(" 20 43 45") > -1) {
          ...
          // ignore.
        } else if (((line.indexOf("Chat  - ") > -1) || (line.indexOf("AbstractChatState  - ") > -1))
            && line.indexOf(" says: '") > -1) {
          name = null;
          // said something.
            ...
            if (handle.equals("System")) {
              ...
              if (user == null) {
                ...
                if (name != null && !name.equals(user.getRoom().getName())) {
                  warn(
                      "New naming convention, room name mismatch: "
                          + name
                          + "!="
  ...
  private static void addUser(
      Room room, String name1, boolean bPublic1, int seat, String handle1, String date) {
